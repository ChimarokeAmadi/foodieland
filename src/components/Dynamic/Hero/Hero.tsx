		...
		<div className='container'>
				...
				<div className='space-y-[48px]'>
					...
					<div className='divide-x-[1px] flex '>
						<div className='flex  gap-4 pr-[58px]'>
							<img src='/Hero/Ellipse 2.png' alt='' className='size-[50px]' />
						...
						<div className='pl-8 flex gap-[10px] items-center'>
							<img
								src='/Dynamic/Hero/ForkKnife.png'
								alt=''
								className='size-6'
							/>
				...
				<div className='flex items-end gap-8 mb-4'>
					<div className='flex flex-col gap-4 items-center'>
						<button className='rounded-[100%] p-7 bg-[#E7FAFE] h-fit '>
							<img src='/Dynamic/Hero/printer.png' alt='' className='size-6' />
						</button>
					...
					<div className='flex flex-col gap-4 items-center'>
						<button className='rounded-[100%] p-7 bg-[#E7FAFE] h-fit '>
							<img src='/Dynamic/Hero/share.png' alt='' className='size-6' />
						</button>
			...
			<div className='flex justify-between'>
				<div className='relative h-fit w-fit'>
					<img src={props.image} alt='' className='rounded-[30px] w-[840px]' />
					<img
